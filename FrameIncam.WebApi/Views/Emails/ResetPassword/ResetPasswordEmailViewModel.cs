...
namespace FrameIncam.WebApi.Views.Emails.ResetPassword
{
    public class ResetPasswordEmailViewModel
    {
        public ResetPasswordEmailViewModel(string t_Username, string t_ClientUrl, string t_CompanyLogoPath, string confirmEmailUrl)
        {
            Username = t_Username;
