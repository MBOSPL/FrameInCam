...
namespace FrameIncam.WebApi.Controllers.Transaction.Project
{
    ...
    [Route("api/transaction/freelancer/project")]
    public class FreelancerController : FrameIncamApiController<TrnProject, ITrnProjectRepository>
    {
        private readonly IHostingEnvironment m_hostingEnvironment;
        public FreelancerController(IHostingEnvironment p_hostingEnvironment)
        {
        ...
        public async Task<FincamApiActionResult<TrnProject>> Add([FromBody] TrnProject p_trnProject)
        {
            ...
            else if (pActiveSubscription.RemainingProjects < 1)
            {
                result.ErrorMsgs.Add("You Already Reached Project Limit " + pActiveSubscription.TotalProjects);
                return result;
            }
        ...
        public async Task<List<TrnProject>> GetByVendor()
        {
            int? vendorId = SecurityContext.GetVendorId();
            ...
            return await this.Repository.GetByVendor(vendorId.Value,null,null);
        }
