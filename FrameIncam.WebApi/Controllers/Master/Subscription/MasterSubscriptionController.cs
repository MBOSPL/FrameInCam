...
namespace FrameIncam.WebApi.Controllers.Master.Vendor
{
    ...
    [Route("api/master/subscription")]
    public class MasterSubscriptionController : FrameIncamApiController<MasterSubscription, IMasterSubscriptionRepository>
    {
        ...
        public async Task <PaymentOrderResponse> CreateOrder(int p_SubscriptionId)
        {
            ...
            MasterSubscription masterSubscription = await this.Repository.GetByIdAsync(p_SubscriptionId);
        ...
        [HttpGet("get-all-vendor")]
        public async Task<List<MasterSubscription>> GetAllVendorSubscriptions()
        {
            List<MasterSubscription> subscriptions = await this.Repository.GetAllVendorSubscriptions();
            return subscriptions;
        }
        [HttpGet("get-all")]
        public async override Task<List<MasterSubscription>> GetAll([FromQuery(Name = "init")] bool p_init = true)
        {
            return await this.Repository.GetAllVendorSubscriptions() ;
        }
    }
}